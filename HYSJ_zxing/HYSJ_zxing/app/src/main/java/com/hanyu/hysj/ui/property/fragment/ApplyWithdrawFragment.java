...
public class ApplyWithdrawFragment extends BaseListFragment {
    ...
    protected void request() {
        NetPresenter.assetLog(KeyUtil.getKey(), getCurrentPage() + "", getCountInPage() + "", "2", new ApiCallBack<AssetLogBean>(getActivity()) {
            @Override
