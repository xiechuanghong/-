...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    public int[] itemStrings = {R.string.attach_take_pic, R.string.attach_picture, R.string.attach_location};
    public int[] itemdrawables = {R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector,
            R.drawable.ease_chat_location_selector};
    public int[] itemIds = {ITEM_TAKE_PICTURE, ITEM_PICTURE, ITEM_LOCATION};
    ...
    protected void initView() {
        ...
        swipeRefreshLayout.setColorSchemeColors(R.color.holo_blue_bright, R.color.holo_green_light,
