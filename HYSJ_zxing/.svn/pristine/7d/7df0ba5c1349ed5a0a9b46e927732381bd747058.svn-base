...
import static com.hanyu.hysj.R.id.virtualKeyboardView;
...
public class SettingWithdrawPwdActivity extends BaseActivity implements PwdView.OnFinishListener,VirtualKeyboardView.OnClickNumberListener{
                ...
                switch (count){
                    ...
                    case 2:
                        if(firstPwd.equals(secondPwd)){
                            ...
                            mBtnOk.setEnabled(false);
                            mBtnOk.setBackgroundDrawable(getResources().getDrawable(R.mipmap.login_color1));
                            NetPresenter.userSetWithdrawPass(KeyUtil.getKey(), firstPwd, secondPwd, "", "", new ApiCallBack<UserSetWithdrawPassBean>(this) {
                                @Override
                                protected void onSuccess(UserSetWithdrawPassBean data, String msg) {
                                    showToast(msg);
                                    LoginLoginBean loginBean = SPUtils.getInstance(SettingWithdrawPwdActivity.this).getLoginBean();
                                    if(loginBean!=null){
