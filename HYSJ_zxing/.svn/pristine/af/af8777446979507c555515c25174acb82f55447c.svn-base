...
public class AllFragment extends BaseListFragment {
    ...
    protected void request() {
        NetPresenter.assetLog(KeyUtil.getKey(), getCurrentPage() + "", getCountInPage() + "", "0", new ApiCallBack<AssetLogBean>(getActivity()) {
            @Override
