...
public class EaseConversationList extends ListView {
    ...
    public void init(List<ConverMesssModle> ListMesMo,List<EMConversation> conversationList){
        this.init(ListMesMo,conversationList, null);
    }

    public void init(List<ConverMesssModle> ListMesMo, List<EMConversation> conversationList, EaseConversationListHelper helper){
        conversations = conversationList;
        if(helper != null){
            this.conversationListHelper = helper;
        }
        adapter = new EaseConversationAdapter(context, 0, conversationList,ListMesMo);
        ///
