...
//            String umage=	message.getStringAttribute("head_image","");
//            Glide.with(context).load(umage).error(R.drawable.ease_default_avatar).into(userAvatarView);
//            String  clikes= EMClient.getInstance().getCurrentUser();
            EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView);
            EaseUserUtils.setUserNick(EMClient.getInstance().getCurrentUser(), usernickView);
//            String Names=	message.getStringAttribute("nickname","");
//            TextView mess= (TextView) findViewById(R.id.tv_userid);
//             System.out.print(Names);
//             //TextView mess= (TextView) findViewById(R.id.tv_userid);
//            if(Names!="") {
//                usernickView.setText(Names);
//                System.out.print("12312312");
//            }else
//            {
//                usernickView.setText(clikes);
//                System.out.print("12312312");
//
//            }
